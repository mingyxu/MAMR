...
def get_config():
    ...
    parser.add_argument("--experiment_name", type=str, default="simu_para", help="an identifier to distinguish different experiment.")
    ...
    parser.add_argument("--num_env_steps", type=int, default=24840, 
    ...
    parser.add_argument("--episode_length", type=int,
                        default=108, help="Max length for any episode")
    ...
    parser.add_argument("--hidden_size_a", type=int, default=1024, 
                        help="Dimension of hidden layers for actor networks") 
    parser.add_argument("--hidden_size_c", type=int, default=1024, 
                        help="Dimension of hidden layers for critic networks") 
    parser.add_argument("--hidden_size_st", type=int, default=128, 
                        help="Dimension of hidden layers for ST-critic networks") 
    ...
    parser.add_argument("--num_mini_batch", type=int, default=50,
    ...
    # eval parameters
    parser.add_argument("--test", default=True, help="by default, do not start testing. If set`, start testing without training.")
    ...
    parser.add_argument("--eval_episodes", type=int, default=7, help="number of episodes of a single evaluation.")
